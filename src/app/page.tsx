...
export default function Home() {
  ...
  return (
    <main className="min-h-screen">
      ...
      <div className="hidden fixed bottom-0 left-0 right-0 z-50 p-3 sm:p-4 pb-[calc(0.75rem+env(safe-area-inset-bottom))] sm:pb-[calc(1rem+env(safe-area-inset-bottom))] bg-white/95 backdrop-blur-md border-t border-gray-200 shadow-[0_-4px_20px_rgba(0,0,0,0.1)]">
        <a
          href="#lead-form"
